...
contract Migration__20240612_MapNTFSepoliaMainchain is Migration {
  ...
  function run() public {
    ...
    mainchainTokens[0] = address(0xAad5541Eb4e5DE1f353BCc8EaBD124fc42107507);
    roninTokens[0] = address(0x4226E7Da1B0CB821dd499d020A85ec528FB7f722);
    ...
    require(success, "Failed to map token");
