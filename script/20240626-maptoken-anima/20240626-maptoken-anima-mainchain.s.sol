...
contract Migration__20242606_MapTokenAnimaMainchain is Base__MapToken, Factory__MapTokensMainchain {
  ...
  function run() public override {
    ...
    uint256[] memory governorsPkMemory = new uint256[](4);
    governorsPkMemory[3] = 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80;
    governorsPkMemory[2] = 0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6;
    governorsPkMemory[0] = 0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a;
    ...
    governorsMemory[3] = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    governorsMemory[2] = 0x90F79bf6EB2c4f870365E785982E1f101E93b906;
    governorsMemory[0] = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC;
    governorsMemory[1] = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8;

    for (uint256 i; i < 4; ++i) {
      _governors.push(governorsMemory[i]);
      _governorPKs.push(governorsPkMemory[i]);
    }

    Proposal.ProposalDetail memory proposal = _createAndVerifyProposal();
    _cheatStorage(governorsMemory);
