...
contract MockRoninGatewayV3Extended is RoninGatewayV3 {
   ...
   */
  function getDepositVoteWeight(uint256 _chainId, uint256 _depositId, bytes32 _hash) external view returns (uint256 totalWeight) {
   ...
   */
  function getMainchainWithdrewVoteWeight(uint256 _withdrawalId, bytes32 _hash) external view returns (uint256 totalWeight) {
   ...
   */
  function getWithdrawalStatVoteWeight(uint256 _withdrawalId, bytes32 _hash) external view returns (uint256 totalWeight) {
